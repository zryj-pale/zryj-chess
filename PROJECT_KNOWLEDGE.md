...
- Środkowa warstwa oddycha: rozjaśnia się i przygasa **cosinusem**, nie piłą. Wcześniej była to pięćdziesięciosekundowa rampa zerowana skokiem — stąd nagły przeskok tła do stanu początkowego przy każdym obiegu. Rampa szła też do 100, co mnożyło każdy kanał tak daleko poza biel, że kolor znikał na długo przed szczytem; `PULSE_MAX` jest teraz na tyle niski, że ciemniejsze kanały barwy zostają pod 1 i w szczycie widać odcień zamiast białego ekranu (zmierzone na samym tle: najjaśniejszy piksel to ok. R=180 G=185 B=250, różnica kanałów 60–80).
