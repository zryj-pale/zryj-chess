...
- `half_angle` czapy musi zostać wyraźnie większy niż to, co kamera z niej widzi (ok. 15–22° zależnie od warstwy), inaczej przy dryfie krawędź płata wjeżdża w kadr. Podniesienie `sway` wymaga podniesienia `half_angle` razem z nim.
