...
- Napisy się KOŁYSZĄ, nie obracają dookoła: `YAW`/`PITCH`/`ROLL` trzymają wychylenie znacznie poniżej ćwierć obrotu (maks. ~34°), więc słowo nigdy nie staje bokiem i zawsze jest zwrócone przodem do gracza. To ograniczenie jest celowe — nie podnoś tych stałych powyżej ok. 1,2 radiana. Tempa osi są wzajemnie niewymierne, żeby ruch nie układał się w jedno powtarzalne bujanie.
